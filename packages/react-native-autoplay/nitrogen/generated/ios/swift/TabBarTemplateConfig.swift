...
/**
 * Represents an instance of `TabBarTemplateConfig`, backed by a C++ struct.
 */
public typealias TabBarTemplateConfig = margelo.nitro.swe.iternio.reactnativeautoplay.TabBarTemplateConfig

public extension TabBarTemplateConfig {
  private typealias bridge = margelo.nitro.swe.iternio.reactnativeautoplay.bridge.swift

  /**
   * Create a new instance of `TabBarTemplateConfig`.
   */
  init(id: String, onWillAppear: ((_ animated: Bool?) -> Void)?, onWillDisappear: ((_ animated: Bool?) -> Void)?, onDidAppear: ((_ animated: Bool?) -> Void)?, onDidDisappear: ((_ animated: Bool?) -> Void)?, onPopped: (() -> Void)?, autoDismissMs: Double?, tabs: [NitroTabBarItem], onTabSelected: ((_ templateId: String) -> Void)?) {
    ...
    }(), { () -> bridge.std__vector_NitroTabBarItem_ in
      var __vector = bridge.create_std__vector_NitroTabBarItem_(tabs.count)
      for __item in tabs {
