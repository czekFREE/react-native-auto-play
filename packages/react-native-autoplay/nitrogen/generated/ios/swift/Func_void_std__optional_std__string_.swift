...
/**
 * Wraps a Swift `(_ completionId: String?) -> Void` as a class.
...
public final class Func_void_std__optional_std__string_ {
  ...
  private let closure: (_ completionId: String?) -> Void

  public init(_ closure: @escaping (_ completionId: String?) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(completionId: bridge.std__optional_std__string_) -> Void {
